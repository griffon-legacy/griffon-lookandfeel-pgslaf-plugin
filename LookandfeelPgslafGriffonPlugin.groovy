 ...
 */
class LookandfeelPgslafGriffonPlugin {
    // the plugin version
    ...
    String source = 'https://github.com/griffon/griffon-lookandfeel-pgslaf-plugin'
    ...
    String title = 'Pluggable Look & Feel based on Pagosoft L&F'
    String description = '''
